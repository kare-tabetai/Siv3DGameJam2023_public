...
public:
	...
	{
		/// @brief バーの背景色
		ColorF backgroundColor=Palette::Darkgray;

		/// @brief 遅延 HP の色
		ColorF delayColor = Palette::Lightgoldenrodyellow;

		/// @brief HP の色
		ColorF hpColor = Palette::Lightgreen;

		/// @brief 枠の色
		ColorF frameColor = Palette::Lightgray;
