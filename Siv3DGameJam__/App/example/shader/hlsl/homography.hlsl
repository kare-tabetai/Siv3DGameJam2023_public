...
{
	const double s = (mat._13 * pos.x + mat._23 * pos.y + mat._33);
	const double x = (mat._11 * pos.x + mat._21 * pos.y + mat._31) / s;
	const double y = (mat._12 * pos.x + mat._22 * pos.y + mat._32) / s;
	return float2(x, y);
}
